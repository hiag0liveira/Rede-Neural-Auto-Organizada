...
public class Teste5RedeNeuralAutoOrganizada {
    ...
    public Teste5RedeNeuralAutoOrganizada(int tamanhoEntrada, int tamanhoSaida, int maxIteracoes, double taxaAprendizado) {
    ...
    public static void main(String[] args) {
        Teste5RedeNeuralAutoOrganizada redeNeural = new Teste5RedeNeuralAutoOrganizada(7, 4, 100, 0.5);
