...
public class Teste2RedeNeuralAutoOrganizada {
    ...
    public Teste2RedeNeuralAutoOrganizada(int tamanhoEntrada, int tamanhoSaida, int maxIteracoes, double taxaAprendizado) {
    ...
    public void treinar() {
        ...
        for (int iteracao = 0; iteracao < maxIteracoes; iteracao++) {
            ...
            if (!ocorreuAlteracao) {
                break; // Se não houve alteração em uma iteração, encerra o treinamento
            }
        }
    }
