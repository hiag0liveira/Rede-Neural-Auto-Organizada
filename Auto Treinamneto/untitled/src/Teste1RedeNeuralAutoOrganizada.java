...
public class Teste1RedeNeuralAutoOrganizada {
    ...
    public Teste1RedeNeuralAutoOrganizada(int tamanhoEntrada, int tamanhoSaida, int maxIteracoes, double taxaAprendizado) {
    ...
    public void treinar() {
        ...
        for (int iteracao = 0; iteracao < maxIteracoes; iteracao++) {
            for (Map.Entry<String, int[]> entrada : tiposVeiculos.entrySet()) {
                ...
                atualizarPesos(indiceVencedor, vetorTipo);
                System.out.println("Iteração: " + iteracao + ", Tipo de Veículo: " + nomeTipo);
            }
        }
    }
    ...
    private void atualizarPesos(int indiceVencedor, int[] entrada) {
    ...
    public static void main(String[] args) {
        Teste1RedeNeuralAutoOrganizada redeNeural = new Teste1RedeNeuralAutoOrganizada(7, 4, 100, 0.5);
