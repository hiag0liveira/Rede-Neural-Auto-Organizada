...
public class Teste3RedeNeuralAutoOrganizada {
    ...
    public Teste3RedeNeuralAutoOrganizada(int tamanhoEntrada, int tamanhoSaida, int maxIteracoes, double taxaAprendizado) {
    ...
    public void treinar() {
        ...
        for (Map.Entry<String, int[]> entrada : tiposVeiculos.entrySet()) {
            ...
            if (ocorreuAlteracao) {
                System.out.println("Vetor: " + nomeTipo + " - Iteração: " + (iteracao - 1));
            }
        }
    }
    ...
    public static void main(String[] args) {
        Teste3RedeNeuralAutoOrganizada redeNeural = new Teste3RedeNeuralAutoOrganizada(7, 4, 100, 0.5);
