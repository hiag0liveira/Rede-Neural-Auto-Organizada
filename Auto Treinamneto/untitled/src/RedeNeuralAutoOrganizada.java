...
public class RedeNeuralAutoOrganizada {
    ...
    public RedeNeuralAutoOrganizada(int tamanhoEntrada, int tamanhoSaida, int maxIteracoes, double taxaAprendizado) {
    ...
    public void treinar() {
        ...
        for (Map.Entry<String, int[]> entrada : tiposVeiculos.entrySet()) {
            ...
            while (iteracao < maxIteracoes && erro >= 0.001) {
                ...
                System.out.println("Vetor: " + nomeTipo + " - Iteração: " + iteracao + " - Erro: " + erro);
                iteracao++;
            }

            System.out.println("Vetor: " + nomeTipo + " - Classificação: " + classificar(vetorTipo));
        }
    }
    ...
    public static void main(String[] args) {
        RedeNeuralAutoOrganizada redeNeural = new RedeNeuralAutoOrganizada(7, 4, 100, 0.5);
        ...
        redeNeural.adicionarTipoVeiculo("Carro", new int[]{0, 0, 0, 0, 1, 1, 0});
